...
**9.0.0** (2023). An embedding is a posting. SIMILAR is a scan. No model. edition 2021. Rust 1.56. No crates.io dependencies.
...
watches the beat. FIND reads meta. A keyed MATCH runs at those
homes. A reader pins a Pos. See `docs/six.md`.
...
`docs/replica.md`, `docs/kernel.md`, `docs/write.md`, and `docs/vec.md`. Type is still not a string. MATCH binds
