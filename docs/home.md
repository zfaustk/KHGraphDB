...
8.0 is `docs/kernel.md`. 8.1 dropped the picture. 8.2 is `docs/write.md`. 9.0 is `docs/vec.md`. 9.1 is engine, lock, replset, snb. 9.2 is `docs/occ.md`. A view is a posting. See `docs/derived.md`.
