...
8.0 is `docs/kernel.md`. 8.1 dropped the picture. 8.2 is `docs/write.md`. 9.0 is `docs/vec.md`. 9.1 is engine, lock, replset, snb. 9.2 is `docs/occ.md`. 9.3 is KEEP. 9.4 is a new Type. 9.5 is an episode. 9.6 is the look. A view is a posting. See `docs/derived.md`.
